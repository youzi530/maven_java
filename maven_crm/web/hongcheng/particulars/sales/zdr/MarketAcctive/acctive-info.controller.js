...
var acctiveInfoCtroller = {
	...
	clientShareApplay:function(id, userId, callBackFun) {
		var url = acctiveInfoCtroller.client_info_url.CLIENT_SHARE_APPLAY;
		jqueryAjax.asynchronusAjaxText(url, {
			"id" : id,
			"userId" : userId
		}, null, callBackFun);
