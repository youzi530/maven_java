var userInfoHTML = {
	...
	linkmanHTML: function(modelId, method) {
		...
		linkmanHtml += '<label for="linkmanName">用户姓名<span style="color: red;">*</span></label>';
		...
		linkmanHtml += '<div class="col-sm-6">';
		linkmanHtml += '<div class="form-group">';
		linkmanHtml += '<label for="status">职员职位</label>';
		if (method == 'update'){
			linkmanHtml += '<select class="form-control" id="position" style="color:#f0b80e;" disabled>';
		}else {
			linkmanHtml += '<select class="form-control" id="position" style="color:#f0b80e;">';
		}
		linkmanHtml += '<option value="admin">管理员</option>';
		linkmanHtml += '<option value="客户经理">客户经理</option>';
		linkmanHtml += '<option value="供销经理">供销经理</option>';
		linkmanHtml += '<option value="客户职员">客户职员</option>';
		linkmanHtml += '<option value="供销职员">供销职员</option>';
		linkmanHtml += '</select>';
		linkmanHtml += '</div></div>';
