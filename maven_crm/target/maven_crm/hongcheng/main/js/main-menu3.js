var mainMenu = {
	...
	logOut: function() {
		...
		/*$.ajax({
			type:"POST",
			url: common.projectPath + "login/logout.htl",
			dataType:"TEXT",
			success: function(data) {
				window.location.href = common.projectPath + "login.jsp";
			}, error: function(data) {
				sweetAlert.error("温馨提示", "请联系开发者！", "确定", 5000);
			}
		});*/
	},
